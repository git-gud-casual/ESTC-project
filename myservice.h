...
#define ESTC_INDICATION_CHAR_UUID 0x0001
#define ESTC_NOTIFICATION_CHAR_UUID 0x0002

#define ESTC_INDICATION_CHAR_DESC "Indication charachteristic"
#define ESTC_NOTIFICATION_CHAR_DESC "Notification charachteristic"
...
typedef struct
{
    ...
    ble_gatts_char_handles_t indication_char;
    ble_gatts_char_handles_t notification_char;
} ble_estc_service_t;
